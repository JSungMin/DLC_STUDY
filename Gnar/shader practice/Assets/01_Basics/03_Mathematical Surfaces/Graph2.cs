...
public class Graph2 : MonoBehaviour
{
    ...
    static private GraphFunction[] functions = { SineFunction, Sine2DFunction, MultiSineFunction, MultiSine2DFunction, Ripple, Cylinder, Sphere, Torus };
    ...
    static private Vector3 Ripple(float x, float z, float t)
    {
        Vector3 p;
    ...
    static private Vector3 Cylinder (float u, float v, float t)
    {
        Vector3 p;
    ...
    static private Vector3 Sphere (float u, float v, float t)
    {
        Vector3 p;
    ...
    static private Vector3 Torus (float u, float v, float t)
    {
        Vector3 p;
